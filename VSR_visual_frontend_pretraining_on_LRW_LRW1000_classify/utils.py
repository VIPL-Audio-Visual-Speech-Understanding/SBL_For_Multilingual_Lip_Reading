...
import numpy as np
import torch
from config import sample_rate,p
...
def save_checkpoint(epoch, epochs_since_improvement, model, optimizer, loss, is_best):
    ...
    if is_best:
        torch.save(state, 'BEST_checkpoint_{}_only_visual_based_lrw_lrw1000_1500.tar'.format(p))
...
def parse_args():
    ...
    parser.add_argument('--checkpoint', type=str, default='BEST_checkpoint_1_only_visual_based_lrw_lrw1000.tar', help='checkpoint')
