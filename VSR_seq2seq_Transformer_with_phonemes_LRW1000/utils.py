...
def save_checkpoint(epoch, epochs_since_improvement, model, optimizer, loss, is_best):
    ...
    if is_best:
        torch.save(state, 'BEST_checkpoint_LRW1000_phonemes_decoding'.format(p))
...
def parse_args():
    ...
    #parser.add_argument('--checkpoint', type=str, default='BEST_checkpoint_1_visual_only_LRW.tar', help='checkpoint')
