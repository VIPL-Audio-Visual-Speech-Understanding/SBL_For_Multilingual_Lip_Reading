...
class AiShellDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        vid_img = load_images(os.path.join('/home/share/DATASET/LRW1000_Public', 'images', imag_path), st, ed, 'gray', self.split == 'train', max_len=30)
        vid = vid_img
        #print(vid.shape)
        ...
        #print(length)
        #vids = np.zeros((57, w, h), dtype=np.float32)
        ...
        return torch.FloatTensor(np.ascontiguousarray(vid)), torch.LongTensor(labels)
        #return vid, trn
