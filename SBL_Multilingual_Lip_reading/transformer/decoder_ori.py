...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        #self.lid_word_emb = nn.Embedding(2, d_word_vec)
    ...
    def recognize_beam(self, encoder_outputs):
        ...
        for i in range(maxlen):
                ...
                #dec_output_r2l = self.dropout(self.tgt_word_emb(ys_r2l) * self.x_logit_scale + self.positional_encoding(ys_r2l))
                ...
                for n in range(self.n_layers-1):
                    ...
                    for i in range(dec_output_l2r.size(1)):
                        dec_output_l2r[:,i] = dec_output_l2r[:, l2r_index[i]]
